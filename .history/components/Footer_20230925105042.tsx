...
export default function Footer() {
  ...
  <footer className='flex flex-col text-black-100  mt-5 border-t border-gray-100'>
    ...
    <div className='flex flex justify-around items-center flex-wrap mt-10 border-t border-gray-100 sm:px-16 px-6 py-10'>
      <p>&copy; {new Date().getFullYear()} Copyright: Car LOFT</p>

      <div className="footer__copyrights-link ml-3">
