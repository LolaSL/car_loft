...
const Contact = () => {
  ...
  return (
    <div
      className={`min-h-screen responsive bg-gray-200 m-4 py-6 container mx-auto px-4 text-blue-800 ${globals}`}
    ...
    <div className="link font-bold mb-4 mt-14">
      ...
      <div className="p-6 justify-center container items-center h-screen flexbox">
        <form
          ...
          className="p-6 flex flex-col justify-center items-center form"
        >
          <div>
