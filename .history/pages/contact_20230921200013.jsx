...
const Contact = () => {
  ...
  return (
    <div
      className={`min-h-screen responsive bg-gray-200 m-4 mx-4 py-6 text-justify container  px-6 text-blue-800 ${globals}`}
    ...
    <div className="link font-bold mb-4 mt-14">
      ...
      <div className="p-6 flex flex-col justify-center items-center">
        <form
          ...
          className="form py-4 mt-4 border-t flex flex-col gap-5 mx-auto"
        >
          <div>
