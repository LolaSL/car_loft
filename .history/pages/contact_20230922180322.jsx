...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      ...
      .then(
        (result) => {
          toast.success("Thank You! Messagehas been sent successfully. We will get back to you as soon as possible.");
  ...
  const saveDataToMongoDB = async () => {
    try {
      ...
      toast.e(["Unable to send message."]);
    }
  };
  return (
    <div
    ...
    >
      ...
      <p>
        ...
        international artists, VIP treatments, pick-ups from the airport, and
        etc.
      </p>
